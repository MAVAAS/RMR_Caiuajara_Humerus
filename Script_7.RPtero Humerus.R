...
# Data
data<-read.table("humerusCPV1032.txt", header=T)

# Tree
tree<-read.nexus("tree1.trees.nex")
...
data<-read.table("humerusCPV1032.txt", header=T) # Reload data to plot it with log10 conversion
